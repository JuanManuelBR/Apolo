...
import { ValidateNested, IsBoolean, IsArray, IsNotEmpty } from "class-validator";
...
export class TestQuestionDto extends BaseQuestionDto {
  // El tipo ya viene validado del BaseQuestionDto
  ...
  @ValidateNested({ each: true, message: "Las opciones de la pregunta deben ser válidas" })
  @Type(() => TestOptionDto)
